...
- [x] Audit SelectTool.ts for edge cases: zero-size selections, rapid clicks, drag threshold
- [x] Ensure all canvas operations handle objects with rotation correctly
...
- [x] Ensure export works correctly with rotated objects and groups
...
### Polish & UX
- [x] Review all cursor changes - ensure they accurately reflect current tool/state
...
- [x] Review error boundary coverage - are all major sections wrapped?
